...
export const Navbar = () => {
	return (
		<nav className="nav container p-5 flex w-full h-160px p-10px text-white">
			<div className="nav-container w-full flex justify-between ">
				...
				>
					<div className="buttons hidden md:flex items-center">
						<div className="buttons-container md:flex text-xl uppercase h-full items-center gap-8">
							<Link href={'/about'} className="mx-2 font-semibold hover:text-secondary duration-150">
								<p>About</p>
							</Link>
							<Link href={'/contact'} className="mx-2 font-semibold hover:text-secondary duration-150 ">
								<p>Contact</p>
							</Link>
						</div>
					</div>
				</MotionConfig>
				<div className="burger md:hidden flex p-2 min-w-[3rem] max-w-[4rem] md:min-w-[4rem] md:max-w-[5rem]">
